...
func sqliteDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&models.Product{}, &models.ProductPricingRule{}, &models.Application{}, &models.ApplicationReviewCheck{}, &models.KnowledgeChunk{}, &models.KnowledgeDocument{}, &models.AuditLog{}); err != nil {
